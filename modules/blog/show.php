<?php
  ...
  // Insert Comment
       ...
       /* Get Page URL */
          ...
          $page_url = 'blog/'.$_POST['bid'].'/#c'.$_POST['bid'];
      ...
      /* Print :: SELECT */
         ...
         $blog->cols      = "id, author, title_DE, message_DE, title_EN, message_EN, date, DATE_FORMAT(date,'%d. %m %Y') as date_formatted, file1, filename1, file2, filename2, file3, filename3, visibility, comments";
         $blog->table     = $tbl_blog;
         if ($Myadmin == 1) $blog->condition = "id = '$bid'";
         else $blog->condition = " deleted = '0' AND visibility = '1' AND UNIX_TIMESTAMP(date) < $timestamp AND id = '$bid' ";
