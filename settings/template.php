    ...
    //    $tpl->caching = false;
     ...
     /* Initialize and Load :: Choosen Language */
        ...
        if ( $_COOKIE["lang"] == '2' || $lang_browser == 'DE' )  {
             ...
             if ($module == "home" or $module == "") $tpl->assign("title_hp", $set[0]["title_hp"]);
             else $tpl->assign("title_hp", $title_hp);
             ...
             if ($module == "home" or $module == "") $tpl->assign("title_hp", $set[0]["title_hp_EN"]);
             else $tpl->assign("title_hp", $title_hp);
