...
<td valign="top" width="50%">
    ...
    <!--table cellspacing="0" cellpadding="0">
     ...
     <tr>
      ...
      <span class="span_101">{$commentsS_title} (<p id="p_num_{$blog.thisid}" class="inline">{$blog.comments_total}</p>)</span>
...
<td align="right" valign="top" width="50%">
    ...
    <table cellspacing="0" cellpadding="0">
     ...
     <tr>
      ...
      <span class="span_101">{$commentsW_title}</span>
        ...
        <div id="commentW_{$blog.thisid}" style="{if $error_id != $blog.thisid}display:none{/if}">
        ...
        <table cellspacing="0" cellpadding="6" width="100%">
         ...
         <tr>
          ...
          {else}
            <p>&nbsp;</p>
            <span class="span_101">{$spam_01}</span>
            <p></p>
            <span class="span_102">{$spam_02}</span>
            <p>&nbsp;</p>
          {/if}
            ...
            <p id="p_page_{$blog.thisid}">
                    ...
                    {foreach key=pagekey item=valuep from=$inner_pages}
                        ...
                        {if $stopthis == 1}
                            ...
                            <nobr><p id="p_cpages_{$blog.thisid}" class="p_002">
