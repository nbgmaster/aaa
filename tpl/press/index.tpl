	...
	<div class="press_1">
	     ...
	     {foreach from=$array item=press name=press}
	      ...
	      <span class="blog_date_c" style="font-size:14px">{$press.date_formatted} &ndash; {$press.source}</span>
	
	      <a href="{$press.link}" target="_blank">
	      <p class="blog_list" style="padding-left:0"><b>{$press.title}</b></p>
	      </a>
	      <p>&nbsp;</p>
	      {$press.text}...
	      <p></p> <a href="{$press.link}" target="_blank" style="font-size:14px;text-decoration:underline">read more</a>
