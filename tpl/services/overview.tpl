 ...
 <script>
   var overlib_bg = "#000";
   var overlib_color = "#fff";
 </script>

<script type="text/javascript" src="{$root_dir}js/overlib/overlib.js"></script>
...
<area shape="rect" coords="96,0,200,51" onclick="parent.location='{$root_dir}services/consulting/'" alt="" title="" onmouseover="return overlib('{$array_short.consulting}');" onmouseout="return nd();" style="cursor:pointer;"   />
<area shape="rect" coords="1,69,105,120" onclick="parent.location='{$root_dir}services/monitoring/'" alt="" title=""  onmouseover="return overlib('{$array_short.monitoring}');" onmouseout="return nd();" style="cursor:pointer;"     />
<area shape="rect" coords="191,69,295,120" onclick="parent.location='{$root_dir}services/development/'" alt="" title=""  onmouseover="return overlib('{$array_short.development}');" onmouseout="return nd();" style="cursor:pointer;"    />
<area shape="rect" coords="32,149,136,200" onclick="parent.location='{$root_dir}services/marketing/'" alt="" title=""  onmouseover="return overlib('{$array_short.marketing}');" onmouseout="return nd();"  style="cursor:pointer;"    />
<area shape="rect" coords="160,149,264,200" onclick="parent.location='{$root_dir}services/publishing/'" alt="" title=""  onmouseover="return overlib('{$array_short.publishing}');" onmouseout="return nd();"  style="cursor:pointer;"    />
</map>

</div>

<div style="text-align:center; width:300px; margin-left:auto; margin-right:auto;" class="services_mobile">
<img id="Image-Maps_3201205141634139" src="{$dir_img}wheel_m_{$sid}.png" usemap="#Image-Maps_3201205141634139" border="0" width="300" height="214" alt="" />
<map id="_Image-Maps_3201205141634139" name="Image-Maps_3201205141634139">
<area shape="rect" coords="96,0,200,51" onclick="parent.location='{$root_dir}services/consulting/'" alt="" title="" onmouseover="return overlib('{$array_short.consulting}');" onmouseout="return nd();" style="cursor:pointer;"     />
<area shape="rect" coords="1,69,105,120" onclick="parent.location='{$root_dir}services/monitoring/'" alt="" title=""  onmouseover="return overlib('{$array_short.monitoring}');" onmouseout="return nd();" style="cursor:pointer;"     />
